...
Info::Info(Type ty, int darkenlighten_factor)
    : ty(ty)
    , darkenlighten_factor(darkenlighten_factor)
{
}

Info::Info(Type ty, int frame_fanciness, unsigned int frame_color)
    : ty(ty)
    , frame_fanciness(frame_fanciness)
...
Info Grayscale::getInfo()
{
    return Info(Type_Grayscale);
}
...
Info BlackAndWhite::getInfo()
{
    return Info(Type_BlackAndWhite);
}
...
Info Merge::getInfo()
{
    return Info(Type_Merge, m_mergeImageFilename);
}
...
Info FlipHorizontally::getInfo()
{
    return Info(Type_FlipHorizontally);
}
...
Info FlipVertically::getInfo()
{
    return Info(Type_FlipVertically);
}
...
bool DarkenAndLighten::hasOptionsMenu() {
    return true;
}
...
Info DarkenAndLighten::getInfo()
{
    return Info(Type_DarkenAndLighten, factor);
}
...
Info Crop::getInfo()
{
    return Info(Type_Crop, m_x, m_y, m_width, m_height);
}
...
Info DetectEdges::getInfo()
{
    return Info(Type_DetectEdges);
}
...
{
    bool update_frame = false;
    if (ImGui::SliderInt("Width", &m_width, 0, image->width * 2)) {
        update_frame = true;
    }
    if (ImGui::SliderInt("Height", &m_height, 0, image->height * 2)) {
        update_frame = true;
    }
    if (update_frame) {
        delete tmpImage;
...
Info Resize::getInfo()
{
    return Info(Type_Resize, m_width, m_height);
}
...
Info Blur::getInfo()
{
    return Info(Type_Blur, m_blurLevel);
}
...
Info Sunlight::getInfo()
{
    return Info(Type_Sunlight);
}
...
Info OilPaint::getInfo()
{
    return Info(Type_OilPaint);
}
...
Info Infrared::getInfo()
{
    return Info(Type_Infrared);
}
...
Info Skew::getInfo()
{
    return Info(Type_Skew, m_skewAngle);
}
...
Info Glasses3D::getInfo()
{
    return Info(Type_Glasses3D, intensity);
}
...
bool MotionBlur::hasOptionsMenu()
{
    return true;
}
...
Info MotionBlur::getInfo()
{
    return Info(Type_MotionBlur, m_blurLevel);
}
